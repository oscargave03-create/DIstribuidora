        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl backdrop-blur-sm">
          ...
          <form onSubmit={handleLocalLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-teal-500 hover:bg-teal-400 text-slate-950 font-semibold py-3 px-4 rounded-xl transition-all shadow-lg shadow-teal-500/10 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 cursor-pointer text-sm font-bold"
            >
              {loading ? (
            ...
            {isConfigured && (
              <>
                <div className="relative my-6 flex items-center justify-center">
                  ...
                  <span className="relative bg-slate-900 px-3 text-[10px] text-slate-500 uppercase tracking-widest font-semibold">O continuar con</span>
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-900 font-semibold py-2.5 px-4 rounded-xl border border-slate-200 transition-all duration-200 shadow-sm hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 cursor-pointer text-xs"
                >
